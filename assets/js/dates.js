(function () {
  ...
  function renderEvent(e) {
    ...
    if (e.url) {
      body +=
        '<div class="date-detail">' +
        '<span class="date-detail-icon" aria-hidden="true">' + ICON_INFO + "</span>" +
        '<a class="date-link" href="' + escapeAttr(e.url) + '" target="_blank" rel="noopener" data-i18n="dates.moreInfo">More information</a>' +
        "</div>";
    }
